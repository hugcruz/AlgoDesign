...
import com.hugomfcruz.algodesign.chapter1.tsp.TSPHeuristicsClosestPair;
import com.hugomfcruz.algodesign.utils.Point;


public class TSPHeuristicsClosestPairTest {
	@Test
	public void testNearestNeighborLinear(){
		...
		assertEquals(expected, TSPHeuristicsClosestPair.calculate(input));
	}
